      ...
      <Box textAlign="center" fontSize="xl" backgroundColor={"#1d1d1d"} width={"100vw"}>
        <Grid minH="100vh" p={3} >
            <Flex fontFamily={"Playwrite"} justifyContent={"flex-end"} zIndex={20}>
              ...
              <Link to={"/infos"}>
                <Text pr={4} color={"white"} _hover={{color:"#ffc5ec", fontWeight:'bold'}} >infos</Text>
              </Link>
            </Flex>
            ...
            <Flex width={"100%"} justifyContent={"flex-end"} pr={200}>
              <Text color={"white"} width={400} textAlign={"left"} border={"dashed 2px"} height={"fit-content"} padding={"20px"} borderRadius={"10px"}>Saluuut, Je m'appelle Astrid et je suis étudiante en BUT informatique. Dans ce portfolio je vous fais part de mes projets et compétence informatiques mais aussi de mes autres centres d'interêts !</Text>
            </Flex>
            <Box width={"100%"}>
              <Fleurs/>
            </Box>
