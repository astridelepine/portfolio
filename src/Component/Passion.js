...
const Passion = () => {
  return (
      ...
      <Box textColor={"black"} textAlign="center" fontSize="xl" backgroundColor={"#FFFFF0"} width={"100%"} minHeight={"100vh"} pt={20}>
          ...
          <Flex flexDir={"column"} py={20} alignItems={"center"}>
            ...
            <Flex width={"60%"} pl={10}>
              <Flex flexDir={"column"} justifyContent={"center"} alignItems={"flex-start"} pl={10}>
                ...
                <Text textAlign={"left"}> Je fais du volley depuis deux ans à l'université. J'ai même pu paticiper aux championats IUT de France et c'était vraiment une superbe experience ! </Text>
              </Flex>
            ...
            <Flex width={"60%"} pl={10}>
              ...
              <Flex flexDir={"column"} justifyContent={"center"} alignItems={"flex-start"} pl={10}>
                ...
                <Text textAlign={"left"}> Je fais de l'appiculture depuis longtemps grace à mes parents eux-même appiculteurs. La periode où je pratique le plus c'est lété au moments des récolte et de l'extraction du miel. C'est un domaine passionnant dans lequel on apprend notamment à être patient et la maîtrise de soi.</Text>
              </Flex>
            </Flex>
            <Flex width={"60%"} pl={10}>
              <Flex flexDir={"column"} justifyContent={"center"} alignItems={"flex-start"} pl={10}>
                <Text fontSize={"2xl"}> La musique :</Text>
                <Text textAlign={"left"}> J'ai fait du violon et du piano pendant plusieurs années, quand j'étais plus jeune. Je suis en train de reprendre le piano et j'aimerais recommencer le violon quand j'aurai fini mes études.</Text>
              </Flex>
        ...
        <Flex flexDir={"column"}>
          <Text fontSize={"3xl"} fontFamily={"Playwrite"}>Mes centres d'interêts</Text>
          <Flex flexDir={"column"} py={20} alignItems={"center"}>
            <Flex width={"60%"} pl={10}>
            ...
            <Flex width={"60%"} pl={10} justifyContent={"flex-end"}>
              <Flex flexDir={"column"} justifyContent={"center"} alignItems={"flex-end"} pl={10}>
            ...
            <Flex width={"60%"} pl={10}  justifyContent={"flex-end"}  >
              <Flex flexDir={"column"} justifyContent={"center"} alignItems={"flex-end"} pr={10}>
                <Text fontSize={"2xl"}> L'espace</Text>
              </Flex>
              <Image width={48} src='/image/espace.png'></Image>
            </Flex>
          </Flex>
        </Flex>
      </Box>
