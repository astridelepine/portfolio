...
const CompetenceCard= ({title, descComp, op1, op2, op3, descNiv, projets}) => {
  return (
      ...
      <Flex textAlign="center" backgroundColor={"#FFFFF0"} p={5} flexDir={"column"} justifyContent={"center"} borderRadius={10} borderColor={'#838383'} opacity={1} borderWidth={2} cursor={"pointer"} mx={10} >
